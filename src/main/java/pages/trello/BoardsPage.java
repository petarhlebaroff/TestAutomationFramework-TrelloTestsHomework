...
public class BoardsPage extends BaseTrelloPage {
    ...
    public void clickOnAsideBoard(String boardName){
        actions.waitForElementPresent("trello.boardsPage.asideBoard", boardName);
        actions.clickElement("trello.boardsPage.asideBoard", boardName);
    }
}
